...
func (a *baseDynamicObject) visitObject(_ int) {
}

func (a *baseDynamicObject) isObjectVisited(_ int) bool {
	return false
}
...
func (a *dynamicArray) visitObject(_ int) {
}

func (a *dynamicArray) isObjectVisited(_ int) bool {
	return false
}
